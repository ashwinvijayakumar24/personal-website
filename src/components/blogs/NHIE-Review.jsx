  ...
  return (
    <div className="blog-content-container">
      ...
      <p>
        ...
        from Mindy Kaling and the writers behind the scenes. A quick example is when Nalini goes to India.
        Her mom says to the maid/housekeeper to get some "paruppu," meaning lentils in English. 
        The problem is, you don't eat parrupu by itself. You combine it with other dishes. Although this 
        is a picky example, there are much more broader examples of the lack of true Indian/Tamil culture. 
        For example, other than Nalini rarely, no one even speaks Tamil. Even when Nalini speaks to her own 
        mother they speak in English.
        <br />
        <br />
        ...
        with (as seen with juggling both Ben and Paxton in the earlier seasons)
        <br />
        <br />
